...
export default class NotifService {
  ...
  localNotif(iNotification) {
    console.log("pushing")

    this.lastId++;
    PushNotification.localNotification({
      /* Android Only Properties */
      channelId: iNotification.soundName ? 'sound-channel-id' : 'default-channel-id',
      ticker: 'My Notification Ticker', // (optional)
      autoCancel: true, // (optional) default: true
      largeIcon: 'ic_launcher', // (optional) default: "ic_launcher"
      smallIcon: 'ic_notification', // (optional) default: "ic_notification" with fallback for "ic_launcher"
      bigText: iNotification.message ? iNotification.message : 'You have a message', // (optional) default: "message" prop
      ...
      title: iNotification.title ? iNotification.title : 'You have a message', // (optional)
      message: iNotification.message ? iNotification.message : 'You have a message', // (required)
      userInfo: {screen: 'home'}, // (optional) default: {} (using null throws a JSON value '<null>' error)
      playSound: !!iNotification.soundName, // (optional) default: true
      soundName: iNotification.soundName ? iNotification.soundName : 'default', // (optional) Sound to play when the notification is shown. Value of 'default' plays the default sound. It can be set to a custom sound such as 'android.resource://com.xyz/raw/my_sound'. It will look for the 'my_sound' audio file in 'res/raw' directory and play it. default: 'default' (default sound is played)
