...
export const HomeNavigator = () => {
   const { deviceData } = useContext(AccountContext )
    return(
    <Drawer.Navigator  screenOptions={{headerShown:false}} drawerContent={props => <HomeDrawer {...props} selected={deviceData.plant_id!==''?3:2}/>} initialRouteName={deviceData.plant_id!==''?AppRoute.WLNAV:AppRoute.LINKAGE} >
