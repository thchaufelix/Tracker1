...
import { StyleSheet, View, Text, TouchableWithoutFeedback, Keyboard, Animated, Easing, Modal,ActivityIndicator,Image, Platform,TouchableOpacity } from 'react-native'
...
export default function SignInScreen({navigation}){ 
    ...
    const { checkAccount,firstLogin,deviceData,versionData, setVersionData,setDeviceData,token }  = useContext(AccountContext)
        ...
        onRequestClose={() => {
            ...
            <View style={styles.centeredView}>
                <View style={styles.modalView}>
                    ...
                    <TouchableOpacity onPress={()=>handleConfirmPressed()} style={[styles.submitBtn2,{backgroundColor:'#73B2B8',width:'100%',alignSelf:'center',paddingHorizontal:"20%"}]}>
...
//    }, []);
    ...
    return(
        <View style={{flex:1,width:'100%',backgroundColor:'white'}}>
            ...
            //     </TouchableOpacity>
            // </AnimatedComponent>
            <Animated.View style={[{position:'absolute',zIndex:1,width:'100%',alignItems:'center',top:'40%'},btnOpacityStyle]}>
                    <TouchableOpacity activeOpacity={1} onPress={()=>loadConfig?handleLogIn():null} style={[styles.submitBtn,{backgroundColor:loadConfig?'#73B2B8':'grey',alignItems:'center'}]}>
            ...
            <View style={{flex:1 }}>
                ...
                /> */}
                <Animated.View style={[styles.container,{borderBottomLeftRadius:bgRadiusValue,borderBottomRightRadius:bgRadiusValue,},{height:topHeight}]}>
                    <Animated.Image style={[styles.logo,{transform:[{scale: scale2},{
                translateY: moveY2}]},{opacity:appOpacity}]} source={require('../../../assets/icon/icon.png')}  />
                    {/* <Text style={styles.logo}>Inspections</Text> */}
                    <Animated.View style={[styles.textBox,{transform: [{scale: scale1},{
                translateX: moveX1},{translateY: moveY1}]},{ top:constants.windowWidth/2-125*constants.HeightRatio,}]}>
                ...
                <Animated.View style={[{backgroundColor:bgColor,position:'absolute',width:'100%',bottom:0,zIndex:-1,justifyContent:'center'},{height:botHeight}]}>
                    <Animated.Image source={require('../../../assets/icon/logo.png')} style={[styles.companyLogo,imageOpacityStyle]} />
                ...
                <Animated.View style={[{position:'absolute',alignSelf:'center',zIndex:1001},{bottom:botRise,opacity:warnOpacity}]}>
