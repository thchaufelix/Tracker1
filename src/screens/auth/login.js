...
export default function LoginForm({navigation, logging}) {
  ...
  const {userData, checkAccount, fa2Login, firstLogin} = useContext(AccountContext2)
              ...
              {isKeyboardVisible ? null :
                <View style={{flexDirection: 'row', width: '100%', alignSelf: 'center'}}>
                  ...
                  <TouchableOpacity onPress={() => handleLoginPress()}>
                    <MaterialIcons style={{opacity: compatible ? 1 : 0}}
                                   name={Platform.OS === 'android' ? "fingerprint" : 'face'} size={35} color="white"
